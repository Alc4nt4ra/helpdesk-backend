...
public class DBService {
	...
	public void instaciaDB() {
		...
		Tecnico tec1 = new Tecnico(null,"Felipe Alcantara", "46530904409","felipealcantara1234@gmail.com","123" );
		tec1.addPerfil(Perfil.ADMIN);
		
		Cliente cli1 = new Cliente(null,"Neymar de Jesus", "38122833608", "NeymarPerigosinho123@gmail.com", "123");
		
		Chamado c1 = new Chamado(null,Prioridade.MEDIA, Status.ANDAMENTO,"Chamado 01", "Primeiro Chamado", tec1, cli1);
		
		Tecnico tec2 = new Tecnico(null, "Carlos Silva", "12345678900", "carlos.silva@email.com", "senha123");
		tec2.addPerfil(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "Mariana Oliveira", "98765432100", "mariana.oliveira@email.com", "senha456");

		Chamado c2 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Chamado 02", "Problema de conexão", tec2, cli2);
		
		Tecnico tec3 = new Tecnico(null, "Roberto Souza", "11122233344", "roberto.souza@email.com", "senha789");
		tec3.addPerfil(Perfil.TECNICO);

		Cliente cli3 = new Cliente(null, "Fernanda Costa", "55566677788", "fernanda.costa@email.com", "senha000");
		...
		Cliente cli4 = new Cliente(null, "João Pedro", "99988877766", "joao.pedro@email.com", "senha654");
